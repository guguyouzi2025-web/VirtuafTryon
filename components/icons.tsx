...
export const GridIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 8.25V6ZM3.75 14.25A2.25 2.25 0 0 1 6 12h2.25a2.25 2.25 0 0 1 2.25 2.25v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25v-2.25ZM13.5 6A2.25 2.25 0 0 1 15.75 3.75h2.25A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25A2.25 2.25 0 0 1 13.5 8.25V6ZM13.5 14.25A2.25 2.25 0 0 1 15.75 12h2.25a2.25 2.25 0 0 1 2.25 2.25v2.25a2.25 2.25 0 0 1-2.25 2.25h-2.25a2.25 2.25 0 0 1-2.25-2.25v-2.25Z" />
    </svg>
);
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909M18.75 12h.008v.008h-.008V12Zm0 0h.008v.008h-.008V12Zm-1.5 1.5h.008v.008h-.008v-.008Zm1.5 0h.008v.008h-.008v-.008Zm0-1.5h.008v.008h-.008V12Zm-3-1.5h.008v.008h-.008V9Zm1.5 0h.008v.008h-.008V9Zm1.5 0h.008v.008h-.008V9Zm-3 3h.008v.008h-.008v-.008Zm0 1.5h.008v.008h-.008V15Zm0 1.5h.008v.008h-.008v-.008Zm-3-3h.008v.008h-.008v-.008Zm-1.5 0h.008v.008h-.008V12Zm-1.5 0h.008v.008h-.008V12Zm1.5 1.5h.008v.008h-.008v-.008Zm-1.5 0h.008v.008h-.008v-.008Zm0 1.5h.008v.008h-.008V15Zm-1.5 1.5h.008v.008h-.008v-.008Zm-3-1.5h.008v.008h-.008V12Zm0-1.5h.008v.008h-.008V9Zm1.5 0h.008v.008h-.008V9Z" />
    </svg>
);
