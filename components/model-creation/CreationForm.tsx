...
export const CreationForm: React.FC<CreationFormProps> = ({ criteria, onCriteriaChange }) => {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-4 text-left">{t('modelCreation.primaryFeatures')}</h3>
            ...
            <div className="pt-6 border-t border-gray-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-4 text-left">{t('modelCreation.bodyDetails')}</h3>
            ...
            <div className="pt-6 border-t border-gray-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-4 text-left">{t('modelCreation.photographyStyle')}</h3>
